...
export const exams: Exam[] = [
  ...
  },
  {
    ...
    short: "WB Police",
    emoji: "👮",
    blurb: "West Bengal Police Constable — GK, elementary maths & reasoning, with West Bengal GK.",
    status: "live",
  ...
  },
  {
    ...
    short: "Clerkship",
    emoji: "🗂️",
    blurb: "WBPSC Clerkship — English, arithmetic & general studies for the West Bengal clerical exam.",
    status: "live",
  ...
  },
  {
    ...
    short: "WBPSC Misc",
    emoji: "📋",
    blurb: "WBPSC Miscellaneous Services — graduate-level GS, arithmetic & reasoning with a WB focus.",
    status: "live",
  ...
  },
  {
    ...
    short: "WB SI",
    emoji: "🚔",
    blurb: "West Bengal Police Sub-Inspector — GS, arithmetic & reasoning practice with a WB focus.",
    status: "live",
  ...
  },
  {
    ...
    short: "Primary TET",
    emoji: "🏫",
    blurb: "West Bengal Primary TET — child development & pedagogy, EVS and teaching methods.",
    status: "live",
